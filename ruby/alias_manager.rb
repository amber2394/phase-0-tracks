...
I cant seem to figure out how to implement the data structure properly... This is what I have so far:
...
fake_names = {}
  ...
  puts "Your secret agent name is:"
  p = str_new.join.reverse.split.map(&:capitalize).reverse.join(' ')
  name = str_new.join.reverse.split.map(&:capitalize).reverse.join(' ')
  fake_names = {}
  fake_names[:fake_name] = name
  end
  puts vowel_adv "aeiou"
loop do
  puts "Are you happy with your secret agent name? (y/n)"
  ...
  if user_input == "n"
    ...
    puts "Your secret agent name is:"
    str_new.join.reverse.split.map(&:capitalize).reverse.join(' ')
    fake_names[:fake_name] = str_new.join.reverse.split.map(&:capitalize).reverse.join(' ')
        end
    puts vowel_adv "aeiou"
  else
    break if user_input == "y"
...
puts "Congratulations on your new secret agent name!"
p fake_names
